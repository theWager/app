    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-900 text-white p-6 rounded-lg max-w-md w-full">
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={onClose} className="text-gray-400 hover:text-white bg-transparent p-1">
            <X size={24} />
          </button>
        </div>
        <div className="space-y-4">
          ...
          <div className="flex space-x-4">
            <div className="flex-1">
              ...
              <p className="text-white">{bet.createdDate.toLocaleDateString()}</p>
            </div>
            <div className="flex-1">
              <p className="text-sm font-medium text-teal-400">Expires:</p>
              <p className="text-white">{bet.expirationDate.toLocaleDateString()}</p>
            </div>
          </div>
          <div className="flex space-x-4">
            <div className="flex-1">
        ...
        <div className="mt-6">
          <button onClick={onClose} className="w-full px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
            Close
          </button>
        </div>
      </div>
