  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <button className='bg-green-600/50  transition-all duration-300 hover:bg-green-700 text-green-300 font-medium rounded w-full h-fit	'>
            Bet Yes
          </button>
          <button className='bg-red-600/50  transition-all duration-300 hover:bg-red-700 text-red-300 font-medium rounded w-full h-fit'>
            Bet No
          </button>
        </div>
      </div>
